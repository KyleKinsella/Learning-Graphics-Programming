...
public:
	...
	// vertical view angle - field of view (aka, fov)
	double vfov = 90;
...
private:
	...
	ray get_ray(int i, int j) const {
		// construct a camera ray originating from the defocus disk and directly at a randomly sampled point around the pixel location i,j
