...
#include "book2/constant_medium.h"
...
void final_scene(int image_width, int samples_per_pixels, int max_depth) {
	...
	cam.samples_per_pixels = samples_per_pixels;
